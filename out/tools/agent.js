...
exports.agentTools = exports.exitPlanModeTool = exports.enterPlanModeTool = exports.skillTool = exports.agentTool = void 0;
const types_1 = require("./types");
// ---------------------------------------------------------------------------
// #11 — Agent (Sub-agent spawning)
// ---------------------------------------------------------------------------
exports.agentTool = (0, types_1.defineTool)({
    name: 'Agent',
    category: 'agent',
...
exports.skillTool = (0, types_1.defineTool)({
    name: 'Skill',
    category: 'agent',
    description: 'Load and execute a predefined skill (specialized workflow). ' +
...
// #24 — EnterPlanMode
// ---------------------------------------------------------------------------
exports.enterPlanModeTool = (0, types_1.defineTool)({
    name: 'EnterPlanMode',
    category: 'agent',
    description: 'Switch to Plan Mode. In Plan Mode, you should only analyze and reason about the problem ' +
...
// #25 — ExitPlanMode
// ---------------------------------------------------------------------------
exports.exitPlanModeTool = (0, types_1.defineTool)({
    name: 'ExitPlanMode',
    category: 'agent',
    description: 'Switch back to Act Mode from Plan Mode. In Act Mode, you execute tools to accomplish tasks. ' +
...
exports.agentTools = [exports.agentTool, exports.skillTool];
