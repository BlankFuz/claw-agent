...
exports.fileTools = exports.notebookEditTool = exports.editFileTool = exports.writeFileTool = exports.readFileTool = void 0;
...
function safeResolvePath(workspaceRoot, filePath) {
...
// #2 — read_file
// ---------------------------------------------------------------------------
exports.readFileTool = (0, types_1.defineTool)({
    name: 'read_file',
    category: 'file',
    description: 'Read the contents of a file in the workspace. Supports offset and limit ' +
...
// #3 — write_file
// ---------------------------------------------------------------------------
exports.writeFileTool = (0, types_1.defineTool)({
    name: 'write_file',
    category: 'file',
...
// #4 — edit_file
// ---------------------------------------------------------------------------
exports.editFileTool = (0, types_1.defineTool)({
    name: 'edit_file',
    category: 'file',
...
// #13 — NotebookEdit
// ---------------------------------------------------------------------------
exports.notebookEditTool = (0, types_1.defineTool)({
    name: 'NotebookEdit',
    category: 'file',
    description: 'Edit Jupyter notebook (.ipynb) cells. Supports replacing cell content, ' +
...
exports.fileTools = [exports.readFileTool, exports.writeFileTool, exports.editFileTool, exports.notebookEditTool];
