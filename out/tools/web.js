...
exports.webTools = exports.webSearchTool = exports.webFetchTool = void 0;
const types_1 = require("./types");
// ---------------------------------------------------------------------------
// #7 — WebFetch
// ---------------------------------------------------------------------------
exports.webFetchTool = (0, types_1.defineTool)({
    name: 'WebFetch',
    category: 'web',
    description: 'Fetch the content of a URL and return it as text. Useful for reading documentation, ' +
...
// #8 — WebSearch
// ---------------------------------------------------------------------------
exports.webSearchTool = (0, types_1.defineTool)({
    name: 'WebSearch',
    category: 'web',
...
exports.webTools = [exports.webFetchTool, exports.webSearchTool];
