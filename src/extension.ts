...
export function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('claw-agent.openChat', () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('claw-agent.newChat', () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('claw-agent.addToContext', () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('claw-agent.addToContextAndAsk', () => {
      const editor = vscode.window.activeTextEditor;
      if (!editor) { return; }
      const selection = editor.selection;
      const text = editor.document.getText(selection);
